...
* Додано кнопку в меню: "ГОЛОВНА"
  ...
  В наступних версіях:
  ! Не забути віставити якір при переключенні мови
  ! Не забути видалити Висвітлений код
  ! Додати підфарбовування назв сторінок
  ? Прозорість картинки і підїзжання піт текс зліва
